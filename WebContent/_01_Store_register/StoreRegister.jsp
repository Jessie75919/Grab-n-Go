...
<jsp:include page="/fragment/top.jsp" />
  ...
  <Table width="700" border='2' cellspacing="0" bgColor='#E7CDFF'>
     ...
     <TR><TD colspan="3">
  <form ENCTYPE="multipart/form-data" method="POST" action="<c:url value='StoreRegister.do' />"  id="register.do" >
      ...
      <input type="text" name="branch" value="${param.branch}"  class="fieldWidth" style="width: 180px;">
      <font color="red" size="-1">${MsgMap.errorBranch}</font>
      ...
      <input type="text" name="owner" value="${param.owner}"  class="fieldWidth" style="width: 180px;">
      <font color="red" size="-1">${MsgMap.errorOwner}</font>
     
      <br/>
      
      <label class="fontSize" >官方網站：</label>
      <input type="text" name="url" value="${param.url}"  class="fieldWidth" style="width: 180px;">
      <font color="red" size="-1">${MsgMap.errorUrl}</font>
      
      <br/>
      
      <label class="fontSize" >主頁面橫幅圖片：</label>
      <Input Type="file" size="40" class="fieldWidth" style="width: 480px;"  name="mainBanner"><BR>
      
      <br/>
      
      <label class="fontSize" >LOGO圖片：</label>
      <Input Type="file" size="40" class="fieldWidth" style="width: 480px;"  name="logo"><BR>
      
      <br/>
      
      <label class="fontSize" >首頁顯示圖片：</label>
      <Input Type="file" size="40" class="fieldWidth" style="width: 480px;"  name="coverImg"><BR>
