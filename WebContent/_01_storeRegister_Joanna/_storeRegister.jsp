...
<!--               <hr> -->
              ...
              <!-- 驗證碼 -->
              <div class="form-group"> <label>I am not Robot! Enter the text:</label>
...
<!--               </div> -->
              ...
              <div class="form-group mx-2"> <label>Store Branch</label>
                <input type="text" name="branch" value="${param.branch}" id="branch" class="form-control" placeholder="Password"> </div>
              <!-- 餐廳地址 -->
              ...
              <div class="form-group mx-2"><label>Contact phone number</label>
                <input type="text" name="tel" value="${param.tel}" id="tel" class="form-control" placeholder="Text"> <span id="telResult" style="height:10px;"></span> </div>
              <!-- 餐廳負責人 -->
