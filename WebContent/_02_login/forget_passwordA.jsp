...
<body>
	...
	<form action="ForgetPassword.do" method="post" class="formcontent">
		<div class="loginList">
			<input type="text" name="eMail" id="eMail" placeholder="請輸入您的E-mail"
				class="validate[required, custom[email]] text-input"> <span
				style="margin: 4px 0 0 0;" id="checkMail"></span>
		</div>
		<div class="loginBtn">
			<input name="reset" type="reset" id="reset" value="重填"> <input
				name="submit" type="submit" id="sub" value="送出">
		</div>
	</form>
	</main>
