...
<jsp:useBean id="orderBeans" class="_05_orderProcess.model.OrderDAO"
	scope="page" />
<c:set target="${orderBeans}" property="username"
...
<body id="top" class="cbp-spmenu-push">
	...
	<div class="rating">
		...
		<form name="searchForm" action="rating.do"  method="get">
			...
			<div class="searchList">
				...
				<input id ="EvaOrd_id" type="hidden" name=ord_Id value="">
	...
	<c:forEach var="anOrderBean" varStatus="statusX"
