...
<body id="top" class="cbp-spmenu-push">
	...
	<!--瀑布流--> <section class="grid slider wow fadeIn" id="container">
	<c:forEach var="rest" items="${Restaurants}">
		<div class="gridItem">
			<figure>
			<img
				src='${pageContext.servletContext.contextPath}/GetImage?no=${rest.rest_Id}&type=coverImage'
				alt="${rest.rest_name}" title="photo">
			<div class="mask">
				<a
					href="${pageContext.servletContext.contextPath}/_07_storePage/getOneRest.do?id=${rest.rest_Id}">觀看菜單</a>
			</div>
			</figure>
			<div class="storeInfo">
				<h2>
					<a
						href="${pageContext.servletContext.contextPath}/_07_storePage/getOneRest.do?id=${rest.rest_Id}">${rest.rest_name}</a>
				</h2>
				<!--有亮的星星class要加上on-->
	...
	</c:forEach> </section> <!--瀑布流 end--> </section> </main>
	<!--搜尋-->
