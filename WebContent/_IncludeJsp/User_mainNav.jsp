...
<body>
	...
	</c:if> <c:if test="${! empty StoreLoginOK}">
		<div class="storeBtn">
			<a href="${pageContext.servletContext.contextPath}/_02_storeLogin/_storeIndex.jsp">店家管理頁面</a>
		</div>
	</c:if>
	<div class="logo">
		<a href="${pageContext.servletContext.contextPath}/indexA.jsp"><img
			src="${pageContext.servletContext.contextPath}/images/share/logo.svg"
	...
	<c:if test="${! empty LoginOK}">
		...
		<div class="rightBtn msgItem"
			onclick="readMsgA('${LoginOK.memberId}')">
		...
		<div class="rightBtn">
			<a
				href="${pageContext.servletContext.contextPath}/_04_ShoppingCart/cartA.jsp"
				title="購物車"> <i class="icon-bag"></i></a><span>${cart.itemNumber}</span>
		</div>
	</c:if>
	<div class="account">
		<ul>
			...
			<c:if test="${empty LoginOK}">
				<li><a
					href="${pageContext.servletContext.contextPath}/_02_login/loginA.jsp">登入</a></li>
			</c:if>
			...
			<c:if test="${! empty LoginOK}">
				<li><a
					href="${pageContext.servletContext.contextPath}/_06_member/memberA.jsp">${LoginOK.memberId}</a></li>
	...
	<ul>
		...
		<li><a
			href="${pageContext.servletContext.contextPath}/_08_about/about.jsp"><i
