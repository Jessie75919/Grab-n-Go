...
<body id="top" class="cbp-spmenu-push">
    ...
    <div class="mainBanner">
        <h1 class="slider wow fadeInDown" data-wow-delay="0.3s">What do you want<br><span class="wBig">TO EAT</span><br><span class="wSmall">today?</span><br><span class="wRed">今天想吃什麼</span></h1>
        <!--main banner 輪播-->
        <div class="banner slider wow fadeIn">
            <div><img src="images/banner/main_banner20170610001.jpg" alt="Grab &amp; Go" title="Grab &amp; Go"></div>
            <div><img src="images/banner/main_banner20170610002.jpg" alt="Grab &amp; Go" title="Grab &amp; Go"></div>
        </div>
        <!--main banner 輪播 end-->
    </div>
    <main>
        ...
        <section class="content bgRed">
            <h2 class="slogan slider wow fadeIn" data-wow-delay="0.5s">"短短的午休時間您受夠了在水深火熱中跟人家相爭排隊買午餐嗎?<br>Grab &amp; Go 預約訂餐系統讓您輕鬆帶著走。"</h2>
        </section>
        <!--標語 end-->
        <!--瀑布流-->
