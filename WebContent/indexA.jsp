				...
				class="icon-list"></i>訂購紀錄</a></li>
                    ...
                    <div class="mainBanner">
                        ...
                        <div class="banner slider wow fadeIn">
                            ...
                            <div>
                                <img src="images/banner/main_banner20170610002.jpg" alt="Grab &amp; Go" title="Grab &amp; Go">
                            </div>
                        </div>
                        <!--main banner 輪播 end-->
                    </div>
                    <main>
                        ...
                        <section class="content bgRed">
                            <h2 class="slogan wow zoomIn" data-wow-delay="0.6s">
                        ...
                        <section class="grid" id="grid">
                            ...
                            <c:forEach var="restaurant" items="${stList}" varStatus='vs'>
                                <div class="gridItem">
                                    <figure> <img src="${pageContext.servletContext.contextPath}/_00_init/getImageA?id=${restaurant.rest_username}&type=restaurant&loc=cover" alt="${restaurant.rest_name}" title="${restaurant.rest_name}">
                                        <div class="mask">
                                    ...
                                    <div class="storeInfo">
                                        ...
                                        <div class="tagOrder">
                                            ...
                                            <div class="orderCount">
                                                <c:set target="${order}" property="restId" value="${restaurant.rest_id}" /> 目前訂單 <span>${order.orderInProgressCountByRestId}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <section class="searchContent">
                            ...
                            <form name="searchForm" action="_22_SearchRest/SearchRestServlet" onsubmit="return validateForm()" method="get">
                                ...
                                <div class="searchList">
                                    <c:set target="${rt}" property="tagName" value='foodKind' /> ${rt.selectTag} <br>
                                ...
                                <div class="searchBtn">
                                    <input name="reset" type="reset" id="reset" value="重填"> <input name="submit" type="submit" id="submit" value="搜尋">
                                </div>
                            </form>
                            <script>
                                    ...
                                    <div class="massageList">
                                        <figure>
                                            <a href="${pageContext.servletContext.contextPath}/_07_storePage/getOneRest.do?id=${rest.rest_id}">
                                                <img src="${pageContext.servletContext.contextPath}/_00_init/getImageA?id=${rest.rest_username}&type=restaurant&loc=logo" alt="${rest.rest_name}" title="${rest.rest_name}">
                                            </a>
                                        </figure>
                                        <div class="massageInfo">
                                            <h3>訂購店家：${rest.rest_name}</h3>
                                            <p>
                                                訂單編號：<a href="_06_member/order_detail.jsp?ordId=${notification.ord_id}&restName=${rest.rest_name}">${notification.ord_id}</a>
                                            </p>
                                            <p>
                                                訊息時間：
                                                <fmt:formatDate type="both" pattern="yyyy-MM-dd HH:mm" value="${notification.noti_time}" />
                                            </p>
                    ...
                    <div id="validMsg">
                        ...
                        <a id="validBtn" href="sendValidMail.do?mode=1&user=${LoginOK.memberId}">點我認證</a> <a href="#" onclick="closePanel()">下次再說</a>
                    </div>
                    <!--loading與驗證 end-->
                    <!--轉盤-->
                    <div class="circle">
