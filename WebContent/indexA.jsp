                                    ...
                                    <div class="storeInfo">
                                        ...
                                        <div class="tagOrder">
                                            ...
                                            <div class="orderCount">
                                                <c:set target="${order}" property="restId" value="${restaurant.rest_id}" /> 目前訂單
                                                <span>${order.orderInProgressCountByRestId}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="massageList">
                                        <figure>
                                            <a href="${pageContext.servletContext.contextPath}/_07_storePage/getOneRest.do?id=${rest.rest_id}">
                                                <img src="${pageContext.servletContext.contextPath}/_00_init/getImageA?id=${rest.rest_name}&type=restaurant&loc=logo" alt="${rest.rest_name}" title="${rest.rest_name}"></a>
                                        </figure>
