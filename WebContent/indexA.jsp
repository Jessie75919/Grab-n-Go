...
<body id="top" class="cbp-spmenu-push">
	...
	<ul>
		...
		<c:if test="${empty LoginOK}">
			<li><a
				href="${pageContext.servletContext.contextPath}/_02_login/forget_passwordA.jsp"
				target="_blank"><i class="icon-list"></i>忘記密碼</a></li>
		</c:if>
		<c:if test="${! empty LoginOK}">
			<li><a
	...
	</section> <!--標語 end--> <!--瀑布流--> <section class="grid" id="grid"> <!-- 	// CALL get_Rest(25.0483199,121.5344137); -->
	...
	<div class="circle">
		<div class="circleContent">
			<div class="zoomBtn">
				<a class="go" href="#"> <i id="wheelClick" class="icon-down"></i>
				</a> <a class="end" href="#"> <i class="icon-close"></i>
				</a>
			</div>
			<div id="venues">
			...
			<div id="counter"></div>
			<div class="goBtn">
				<a id="goGo" href="#">點我至Afternoon Tea</a>
			</div>
		</div>
